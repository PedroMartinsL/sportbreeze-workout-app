...
from schemas.routine_schema import ListRoutineResponse, RoutineCreate, RoutineResponse
...
@routine_router.get("/", response_model=ListRoutineResponse)
async def get_routine_by_user(use_case: FindRoutinesByUserUseCase = Depends(), user: User = Depends(verify_token)):
